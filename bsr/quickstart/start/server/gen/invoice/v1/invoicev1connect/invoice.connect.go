...
import (
	...
	context "context"
	errors "errors"
	v1 "github.com/bufbuild/buf-examples/bsr/quickstart/server/gen/invoice/v1"
	http "net/http"
	strings "strings"
)
...
type InvoiceServiceClient interface {
	...
	CreateInvoice(context.Context, *v1.CreateInvoiceRequest) (*v1.CreateInvoiceResponse, error)
}
...
func NewInvoiceServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) InvoiceServiceClient {
	...
	invoiceServiceMethods := v1.File_invoice_v1_invoice_proto.Services().ByName("InvoiceService").Methods()
...
func (c *invoiceServiceClient) CreateInvoice(ctx context.Context, req *v1.CreateInvoiceRequest) (*v1.CreateInvoiceResponse, error) {
	response, err := c.createInvoice.CallUnary(ctx, connect.NewRequest(req))
	if response != nil {
...
func NewInvoiceServiceHandler(svc InvoiceServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	invoiceServiceMethods := v1.File_invoice_v1_invoice_proto.Services().ByName("InvoiceService").Methods()
	invoiceServiceCreateInvoiceHandler := connect.NewUnaryHandlerSimple(
...
func (UnimplementedInvoiceServiceHandler) CreateInvoice(context.Context, *v1.CreateInvoiceRequest) (*v1.CreateInvoiceResponse, error) {
