...
type PetStoreServiceClient interface {
	GetPet(context.Context, *v1.GetPetRequest) (*v1.GetPetResponse, error)
	PutPet(context.Context, *v1.PutPetRequest) (*v1.PutPetResponse, error)
	DeletePet(context.Context, *v1.DeletePetRequest) (*v1.DeletePetResponse, error)
}
...
func (c *petStoreServiceClient) GetPet(ctx context.Context, req *v1.GetPetRequest) (*v1.GetPetResponse, error) {
	response, err := c.getPet.CallUnary(ctx, connect.NewRequest(req))
	if response != nil {
...
func (c *petStoreServiceClient) PutPet(ctx context.Context, req *v1.PutPetRequest) (*v1.PutPetResponse, error) {
	response, err := c.putPet.CallUnary(ctx, connect.NewRequest(req))
	if response != nil {
		return response.Msg, err
	}
	return nil, err
...
func (c *petStoreServiceClient) DeletePet(ctx context.Context, req *v1.DeletePetRequest) (*v1.DeletePetResponse, error) {
	response, err := c.deletePet.CallUnary(ctx, connect.NewRequest(req))
	if response != nil {
		return response.Msg, err
	}
	return nil, err
...
func NewPetStoreServiceHandler(svc PetStoreServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	petStoreServiceMethods := v1.File_pet_v1_pet_proto.Services().ByName("PetStoreService").Methods()
	petStoreServiceGetPetHandler := connect.NewUnaryHandlerSimple(
		PetStoreServiceGetPetProcedure,
		svc.GetPet,
		connect.WithSchema(petStoreServiceMethods.ByName("GetPet")),
		connect.WithHandlerOptions(opts...),
	)
	petStoreServicePutPetHandler := connect.NewUnaryHandlerSimple(
		PetStoreServicePutPetProcedure,
		svc.PutPet,
		connect.WithSchema(petStoreServiceMethods.ByName("PutPet")),
		connect.WithHandlerOptions(opts...),
	)
	petStoreServiceDeletePetHandler := connect.NewUnaryHandlerSimple(
...
func (UnimplementedPetStoreServiceHandler) GetPet(context.Context, *v1.GetPetRequest) (*v1.GetPetResponse, error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("pet.v1.PetStoreService.GetPet is not implemented"))
}

func (UnimplementedPetStoreServiceHandler) PutPet(context.Context, *v1.PutPetRequest) (*v1.PutPetResponse, error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("pet.v1.PetStoreService.PutPet is not implemented"))
}

func (UnimplementedPetStoreServiceHandler) DeletePet(context.Context, *v1.DeletePetRequest) (*v1.DeletePetResponse, error) {
